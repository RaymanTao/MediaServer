...
# Settings
BASE_RTP_FILE="/kms/config/kurento/BaseRtpEndpoint.conf.ini"
WEBRTC_FILE="/kms/config/kurento/WebRtcEndpoint.conf.ini"
...
exec /kms/kurento-media-server/server/kurento-media-server "$@"
